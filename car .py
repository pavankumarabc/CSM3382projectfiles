...
# Data Preprocessing:
# a. Clean the data by handling missing values, outliers, and duplicates
data = data.drop_duplicates()

# Convert car_price_in_rupees to a consistent numerical format
data['car_price_in_rupees'] = data['car_price_in_rupees'].apply(convert_price)

# Convert kms_driven to a numeric format
